...
def readTempData():
    ...
    rawData = bus.read_i2c_block_data(MPU9250_ADDRESS, TEMP_OUT_H, 2)
    temp = uint_16_to_int16((rawData[0] << 8) | rawData[1])
...
def main():
    ...
    while running:
        if (bus.read_byte_data(MPU9250_ADDRESS, INT_STATUS) & 0x01):
            ...
            tempCount = readTempData() # Read the temperature adc value
