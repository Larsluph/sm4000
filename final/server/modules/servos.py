...
def move(com_port, id, position, speed):
    ...
    data_to_send = '#' + str(id) + ' P' + str(position) + ' T' + str(speed) + chr(13) #a serial string to send to the com port. The instruction move the servo id with position and speed parameters.
