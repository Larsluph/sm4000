...
while running:
  ...
  if checks["oxygen"]:
    ...
    values["dissolved_oxygen"] = oxygen.query("R").rstrip("\x00") # = 'Success: 9.76\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
