...
tk.Label(win,font=(font[0],font[1]*multi), text=f"{var} :").grid(row=4,column=0,columnspan=4,rowspan=2,sticky=tk.E)
tk.Label(win,font=(font[0],font[1]*multi), textvariable=tk_vars[var] ).grid(row=4,column=4,columnspan=4,rowspan=2,sticky=tk.W)
